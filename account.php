        ...
        <div class="header">
            <div class="profile-section">
                ...
                <div class="user-info">
                    ...
                    <p><?php echo htmlspecialchars($user_data['email'] ??
                        '<span data-translate-it="Email non impostata" data-translate-en="Email not set">' . $email_not_set . '</span>'); ?>
                    </p>
                </div>
            </div>
                ...
                <form method="POST" autocomplete="off" id="profileForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email"
                            ...
                            placeholder="tua@email.com" autocomplete="new-email" data-placeholder-en="your@email.com"
                            data-placeholder-it="tua@email.com">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="password-forgot.php" class="forgot-password-link"
                            data-translate-en="Forgot your password?" data-translate-it="Password dimenticata?">
                    ...
                    <div class="password-section" id="passwordSection">
                        ...
                        <div class="password-fields" id="passwordFields">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="new_password" data-translate-it="Nuova Password"
                                        data-translate-en="New Password">Nuova Password</label>
                                    <div class="input-container">
                    ...
                    <button type="submit" name="update_profile" class="btn" id="updateProfileBtn">
                        ...
                        <span id="saveChangesText" data-translate-it="Salva Modifiche"
                            data-translate-en="Save Changes">Salva Modifiche</span>
                    </button>
                </form>
            </div>
    ...
    <div class="photo-modal-overlay" id="photoModal">
        ...
        <div class="photo-modal">
            <?php if (!empty($user_data['profile_photo']) && file_exists($user_data['profile_photo'])): ?>
                <img src="<?php echo htmlspecialchars($user_data['profile_photo']); ?>" alt="Foto Profilo"
                    class="enlarged-photo" style="width: 300px; height: 300px; border-radius: 50%; object-fit: cover;">
            <?php else: ?>
            ...
            <div class="photo-upload-form">
                <h4 style="margin-bottom: 20px; color: #1f2937; font-weight: 600;"
                    data-translate-en="Change Profile Photo" data-translate-it="Cambia Foto Profilo">Cambia Foto Profilo
                </h4>
                <form method="POST" enctype="multipart/form-data" autocomplete="off" id="photoUploadForm">
                    <div class="file-input-wrapper">
                        ...
                        <div class="file-input-content">
                            <i class="fas fa-cloud-upload-alt"
                                style="font-size: 24px; margin-bottom: 8px; color: #4f46e5;"></i>
                            <p style="margin-bottom: 4px; font-weight: 500;"
                                data-translate-en="Click to select an image"
                    ...
                    <div style="display: flex; gap: 12px; justify-content: center;">
                        <button type="submit" name="upload_photo" class="btn" id="uploadPhotoBtn"
                            data-translate-en="Upload Photo" data-translate-it="Carica Foto">
                            <i class="fas fa-upload"></i>
                            <span>Carica Foto</span>
                        </button>
                        <button type="button" onclick="closePhotoModal()" class="btn btn-secondary"
                            data-translate-en="Cancel" data-translate-it="Annulla">
                            <i class="fas fa-times"></i>
                            <span>Annulla</span>
                        </button>
                    </div>
            ...
            <form method="POST" id="deleteForm" autocomplete="off">
                <div class="form-group">
                    ...
                    <div class="input-container">
                        <input type="password" id="delete_password" name="delete_password" required
                            autocomplete="new-password" style="border-color: #fca5a5;">
                ...
                <div class="modal-buttons">
                    <button type="button" onclick="closeDeleteModal()" class="btn btn-secondary"
                        data-translate-it="Annulla" data-translate-en="Cancel">
                        <i class="fas fa-times"></i>
                        <span>Annulla</span>
                    </button>
